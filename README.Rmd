...
You can install the development version of fmt from [GitHub](https://github.com/selkamand/fmt) with:
...
Convert to percentage with `fmtpercent` or scientific notation `fmtscientific`.
